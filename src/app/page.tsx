...
export default function Home() {
  ...
  return (
    <>
      ...
      <section ref={worksRef} id="photos" className="relative bg-[#0a0a0a] pt-18 md:pt-24 pb-20 md:pb-32 border-t border-white/10">
        {/* Section header */}
      ...
      <section id="videos" className="relative bg-[#050505] pt-18 md:pt-24 pb-16 border-t border-white/10">
        <div className="px-5 md:px-16 mb-8 md:mb-12">
          <div data-text-reveal className="flex items-center gap-6 mb-8 md:mb-10">
            <span className="font-inter text-[10px] md:text-[11px] tracking-[0.3em] text-white/40 uppercase">
              02
      ...
      {/* ═══════════════════ ABOUT SECTION (03) ═══════════════════ */}
      <section ref={aboutRef} id="about" className="relative bg-[#0d0d0d] min-h-screen flex flex-col justify-start pt-18 md:pt-24 pb-32 md:pb-48 overflow-hidden border-t border-white/10">
      ...
      {/* ═══════════════════ CONTACT / FOOTER (04) ═══════════════════ */}
      <footer ref={contactRef} id="contact" className="relative bg-[#050505] pt-18 md:pt-24 pb-4 md:pb-12 min-h-[85vh] md:min-h-screen flex flex-col justify-between overflow-hidden border-t border-white/10">
