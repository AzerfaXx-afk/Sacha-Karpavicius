...
export default function Home() {
  ...
  return (
    <>
      ...
      <section ref={worksRef} id="photos" className="relative bg-[#0a0a0a] pt-10 md:pt-[64px] pb-20 md:pb-32 scroll-mt-0">
        {/* Section header */}
      ...
      <section id="videos" className="relative bg-[#050505] pt-10 md:pt-[64px] pb-20 md:pb-32 scroll-mt-0">
        <div className="px-5 md:px-16 mb-8 md:mb-12">
          <div data-text-reveal className="flex items-center gap-6 mb-8 md:mb-10">
            <span className="font-inter text-[10px] md:text-[11px] tracking-[0.3em] text-white/40 uppercase">
              02
      ...
      {/* ═══════════════════ ABOUT SECTION (03) ═══════════════════ */}
      <section ref={aboutRef} id="about" className="relative bg-[#0d0d0d] min-h-screen flex flex-col justify-between pt-10 md:pt-[64px] pb-8 md:pb-12 overflow-hidden scroll-mt-0">
        <div className="px-5 md:px-16 flex-1 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
              ...
              {/* Right Column: Large Portrait Card with Organic Circular LED Aura (5 Cols) - Shifted left & equidistant */}
              <div className="md:col-span-5 flex justify-center md:justify-center items-center md:pr-6 lg:pr-12 xl:pr-20" data-text-reveal>
      ...
      {/* ═══════════════════ CONTACT / FOOTER (04) ═══════════════════ */}
      <footer ref={contactRef} id="contact" className="relative bg-[#050505] pt-10 md:pt-[64px] pb-4 md:pb-12 min-h-[85vh] md:min-h-screen flex flex-col justify-between overflow-hidden scroll-mt-0">
        <div className="px-5 md:px-16 flex-1 flex flex-col justify-between">
          <div>
            <div data-text-reveal className="flex items-center gap-6 mb-8 md:mb-10">
              <span className="font-inter text-[10px] md:text-[11px] tracking-[0.3em] text-white/40 uppercase">
